    ...
    , ui(new Ui::Igra)
{
    ...
    QObject::connect(this, &Igra::ucitajIDKviza, this, &Igra::ucitavanjeIDKviza);
    QObject::connect(this, &Igra::ucitajBazu, this, &Igra::ucitavanjeBaze);
